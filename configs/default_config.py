...
# 要生成的类别（None = 所有类别）
synthetic_classes_to_generate = None  # 或 [0, 1, 2, 5]
...
feature_display_names = [
    "左足陀螺仪X", "左足陀螺仪Y", "左足陀螺仪Z", "左足加速度计X", "左足加速度计Y", "左足加速度计Z",
    "左小腿陀螺仪X", "左小腿陀螺仪Y", "左小腿陀螺仪Z", "左小腿加速度计X", "左小腿加速度计Y", "左小腿加速度计Z",
    "左大腿陀螺仪X", "左大腿陀螺仪Y", "左大腿陀螺仪Z", "左大腿加速度计X", "左大腿加速度计Y", "左大腿加速度计Z",
    "左鞋垫压力中心X（COP X）", "左鞋垫压力中心Z（COP Z）", "左鞋垫垂直地面反力/压力Y（Force Y）", "左髋关节角度", "左髋关节角速度（滤波）",
    "左膝关节角度", "左膝关节角速度（滤波）", "左髋关节力矩", "左膝关节力矩", "左侧掩码",
    "右足陀螺仪X", "右足陀螺仪Y", "右足陀螺仪Z", "右足加速度计X", "右足加速度计Y", "右足加速度计Z",
    "右小腿陀螺仪X", "右小腿陀螺仪Y", "右小腿陀螺仪Z", "右小腿加速度计X", "右小腿加速度计Y", "右小腿加速度计Z",
    "右大腿陀螺仪X", "右大腿陀螺仪Y", "右大腿陀螺仪Z", "右大腿加速度计X", "右大腿加速度计Y", "右大腿加速度计Z",
    "右鞋垫压力中心X（COP X）", "右鞋垫压力中心Z（COP Z）", "右鞋垫垂直地面反力/压力Y（Force Y）", "右髋关节角度", "右髋关节角速度（滤波）",
    "右膝关节角度", "右膝关节角速度（滤波）", "右髋关节力矩", "右膝关节力矩", "右侧掩码"
]